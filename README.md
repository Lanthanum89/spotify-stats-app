...
- **Analysis tab**: A sticky in-page nav jumps between four groups, with a "Key Insights" summary up top distilling the data already loaded (top genre, most active day, etc.) before the detailed charts:
  ...
  - *Listening Habits* — an hourly listening-activity chart and a day-of-week activity chart, both from the last 50 streams, with hover tooltips.
